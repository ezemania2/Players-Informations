...
//MOD CONFIG
inline const std::string NAME = "Player Informations"; //Name of the mod, used for the required/allowed checks and to check if loaded mod is unique
inline const std::string DISPLAY_NAME = "Player Informations"; //Display name in game, used mainly for the imgui context
